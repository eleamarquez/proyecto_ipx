										...
										<div class="colm colm6">
											...
											<div class="section">
												<label class="field">
													...
													<input type="text" name="cedula" id="cedula"class="gui-input" value="" required>
											...
											<div class="section">
												<label class="field ">
													...
													<input type="date" name="fecha" id="fecha" class="gui-input" value=" "required>
										...
										<div class="colm colm6">
											...
											<div class="section">
												<label class="field ">
													...
													<input type="text" name="empleado" id="empleado"  class="gui-input" value="" required>
