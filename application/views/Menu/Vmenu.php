				...
				<div class="header-main">
					<div class="header-left">
						<div class="logo-name">
							...
							<img src="http://www.ipx.com.co/img/0404/128.jpg" height="50" width="100" alt="">
							</a> 								
						</div>
						<!--search-box-->
		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu" >
					...
					<li id="menu-comunicacao" ><a href="<?php echo base_url(); ?>C_Menu/"><i class="fa fa-book nav_icon"></i><span>Clientes</span><span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-comunicacao-sub" >
							<li id="menu-mensagens" style="width: 120px" ><a href="<?php echo base_url(); ?>C_Menu/Clientes">Registro de Cliente</a></li>
						</ul>
					</li>
